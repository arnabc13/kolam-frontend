...
// ============================================================================
const CONFIG = {
    API_BASE_URL: 'http://localhost:5000',  // ← CHANGE THIS LINE FOR YOUR BACKEND
    API_ENDPOINTS: {
...
class KolamApp {
    ...
    async generateKolam(params) {
        try {
            ...
            // Show loading state
            this.previewArea.innerHTML = '<div class="loading">🎨 Generating kolam pattern...</div>';

            // ============================================================================
            // 🌐 API CALL TO BACKEND - THIS IS WHERE THE MAGIC HAPPENS
            // ============================================================================
        ...
        this.previewArea.innerHTML = `
            <div class="error-message" style="padding: 20px; text-align: center; border: 2px dashed #ff6b6b; border-radius: 8px; background: #ffe0e0;">
                ...
                <p style="color: #636e72; font-size: 0.9em;">
                    ...
                    1. Make sure backend server is running: <code>python backend.py</code><br>
                    2. Check backend URL: <code>${CONFIG.API_BASE_URL}</code><br>
...
document.addEventListener('DOMContentLoaded', async () => {
    try {
        ...
        console.log('1. Run: python backend.py');
        console.log(`2. Ensure backend is running on: ${CONFIG.API_BASE_URL}`);
